                     ...
                     <div class="row column_title">
                        <div class="col-md-12">
                           <div class="page_title">
                              <div class="row">
                                 <div class="col-xs-3 col-sm-4 col-md-4 col-lg-7 align-self-center">
                                    <h2>
                                       <i class="fad fa-info-square fa-lg"></i> Issuing Details
                                    </h2>
                                 </div>
                                 ...
                                 <div class="col-xs-3 col-sm-4 col-md-4 col-lg-2 pr-0 align-self-center">     
